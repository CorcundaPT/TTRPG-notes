...
const specie = {
	...
	"elvenLineage": {
		...
		"infoExtra":[
			"<b class='infoBold'>1st Level:</b> You know Dancing Lights cantrip.",
			"<b class='infoBold'>3st Level:</b> You learn Faerie Fire spell.",
			"<b class='infoBold'>5st Level:</b> You learn Darkness spell."
		]
	},
	"feyAncestry": {
		"name":"Fey Ancestry",
