const specieName = "Elf (High-Elf)"
const specie = {
	"darkvision": {
		"name":"Darkvision",
		"type":"Elf(Drow) Feature",
		"info":[
	...
	"elvenLineage": {
		...
		"infoExtra":[
			"<b class='infoBold'>1st Level:</b> You know one Wizard cantrip spell of your choice. Whenever you finish a Long Rest, you can replace it with a different Wizard cantrip spell.",
			"<b class='infoBold'>3st Level:</b> You learn Detect Magic spell.",
			"<b class='infoBold'>5st Level:</b> You learn Misty Step spell."
		]
	},
	"feyAncestry": {
		"name":"Fey Ancestry",
